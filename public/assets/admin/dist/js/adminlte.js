 ...
 */ (function (global, factory) {
        ...
        _proto.minimize = function minimize() {
            ...
            this._parent
                ...
                .queue(function () {
                    ...
                    $element.css({ height: "inherit", width: "inherit" });
    ...
    var Dropdown = (function () {
        ...
        _proto.fixPosition = function fixPosition() {
            ...
            if ($element.hasClass(CLASS_NAME_DROPDOWN_RIGHT)) {
                $element.css({ left: "inherit", right: 0 });
            } else {
                $element.css({ left: 0, right: "inherit" });
            }
            ...
            if (offset.left < 0) {
                $element.css({ left: "inherit", right: offset.left - 5 });
    ...
    var Default$3 = { resetOnClose: true, target: SELECTOR_SEARCH_BLOCK };
